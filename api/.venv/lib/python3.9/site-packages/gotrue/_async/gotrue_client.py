...
# the errors in this file that need to be fixed are 
# AuthSessionMissingError, AuthImplicitGrantRedirectError, AuthInvalidCredentialsError, AuthApiError, AuthRetryableError, and AuthInvalidJwtError. They are all custom exceptions that should be defined in the gotrue.exceptions module. 
